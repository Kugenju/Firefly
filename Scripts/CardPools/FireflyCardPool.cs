...
public sealed class FireflyCardPool : CustomCardPoolModel
{
    ...
    protected override CardModel[] GenerateAllCards()
    {
        return new CardModel[]
        {
            ...
            ModelDb.Card<FlashIgniteStrike>(),
            ModelDb.Card<ArmoredDefense>(),
            ModelDb.Card<FireflyWildfire>(),
            ModelDb.Card<IgniteTheSea>(),
            ModelDb.Card<FlamesSpread>(),
            ...
            // 第二批：罕见攻击卡
            ModelDb.Card<Devastator>(),
            ModelDb.Card<RisingFlame>(),
            ModelDb.Card<FireflySwarmAttack>(),
            ModelDb.Card<GentleNightStrike>(),
            ModelDb.Card<EntropyBlade>(),
            ModelDb.Card<LifeBurn>(),
            ModelDb.Card<ScatterFlame>(),
