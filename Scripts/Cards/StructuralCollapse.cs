...
/// <summary>
/// 结构崩解 (Structural Collapse) - 普通攻击卡
/// 
/// "萨姆的利刃..."
/// 
...
{
    public StructuralCollapse() : base(2, CardType.Attack, CardRarity.Common, TargetType.AnyEnemy, false)
    {
    }
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        if (targetBlock > 0)
        {
            ...
            // 这里使用CreatureCmd.Damage，但设置特定属性让伤害优先攻击格挡
